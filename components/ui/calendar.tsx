...
function Calendar({
	...
	return (
		<DayPicker
			...
			modifiersClassNames={{ booked: "bg-red-500/70 rounded-none" }}
			showOutsideDays={showOutsideDays}
			className={cn("p-6", className)}
			classNames={{
				months:
					"flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0 text-first",
				...
				head_row: "flex",
				head_cell: "text-first rounded-md w-9 font-normal text-[0.8rem] w-full",
