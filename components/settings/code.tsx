...
export const Scrambles = ({
	...
	return (
		<div className="flex flex-col justify-center gap-5 p-10">
			<div className="border-2 borderColor flex items-center justify-center px-6 py-2 pt-4 rounded-3xl text-4xl">
				<span className="text-first-muted leading-none font-extrabold">
