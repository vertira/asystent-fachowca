...
export default function RegisterForm({
    ...
    if (error) {
      if (error.error === "USER") {
        ...
        toast({
          variant: "destructive",
          title: "Wystąpił problem z rejestracją",
          description: "Nieprawidłowy, wykorzystany lub wygasły kod pracownika",
        });
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col w-3/4 max-w-sm items-start gap-1.5">
            ...
            <Tooltip delayDuration={200}>
              <TooltipTrigger onClick={(e) => e.preventDefault()}>
                <div className="flex items-center">
                  <Label htmlFor="registrationCode">Kod pracownika</Label>
                  <sup>
                    <Info size={12} className="text-first-muted" />
                  </sup>
                </div>
              </TooltipTrigger>
              <TooltipContent>
                <p>
                  ...
                  <br /> Zostaniesz zarejestrowany jako szef swojego biznesu !
                </p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
...
function Submit() {
  ...
  return (
    <Button
      ...
      disabled={pending}
      type="submit"
      className=" flex items-center justify-center gap-4 mt-5 w-3/4 max-w-sm"
    >
