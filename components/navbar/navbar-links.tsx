	...
	return (
		<>
			<div>
				<div className="px-5 pt-4">
					<div className="w-full flex justify-start items-center gap-4 ">
						<Avatar className="ring-1 ring-offset-2 ring-offset-myBackground ring-first-muted">
			...
			<div className="mt-auto flex flex-col gap-2 border-t border-myText-muted/30 px-4 py-4">
					...
					<Button
						...
						className={`link text-base ${
							pathname === "/settings"
								? "bg-cardBackground text-first-muted"
								: ""
						} flex items-center gap-3 rounded-md px-3 py-2 text-myText-muted transition-all w-full hover:text-first-muted`}
					>
				...
				<Button
					variant="third"
					className="flex items-center gap-3 rounded-md px-3 py-2 text-myText-muted transition-all w-full hover:text-first-muted"
					onClick={() => signOut()}
				>
