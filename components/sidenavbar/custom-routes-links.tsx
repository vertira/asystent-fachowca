      ...
      <Link
        className={`link ${
          pathname === "/new-work"
            ...
            : "text-myText-muted"
        } flex items-center justify-start gap-4  group/sidebar py-4 link border-b border-white/10 hover:text-first-muted tour-new-work`}
        onClick={handleClick}
        href="/new-work"
      >
    ...
    <Link
      ...
      className={`link ${
        pathname === "/settings"
          ? "text-first-muted font-extrabold"
          : "text-myText-muted"
      } flex items-center justify-start gap-2  group/link py-4 link border-b border-white/10 hover:text-first-muted tour-settings`}
    >
