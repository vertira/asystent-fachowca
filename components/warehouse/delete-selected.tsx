...
export const DeleteSelected: React.FC<DeleteSelectedProps> = ({ table }) => {
    ...
    return (
        <AlertDialog>
            ...
            <AlertDialogContent className="borderColor border bg-cardBackground">
                <AlertDialogHeader className="text-myText">
                    ...
                    <AlertDialogDescription className="text-myText-muted">
                        ...
                        usunięcie Twoich danych z naszych serwerów.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                    <AlertDialogCancel className="borderColor border bg-cardBackground text-myText-muted hover:bg-cardBackground hover:text-first-muted">
                        Anuluj
                    </AlertDialogCancel>
                    <AlertDialogAction
                        onClick={handleDeleteSelected}
                        className="borderColor border bg-myBackground text-first-muted hover:border-first-muted hover:bg-cardBackground"
                    >
