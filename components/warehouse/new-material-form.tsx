...
export default function MaterialForm({
    ...
    return (
        ...
        >
            <div className="flex w-3/4 flex-col items-start gap-1.5 lg:w-2/5">
            ...
            <div className="flex w-3/4 flex-row items-center gap-1.5 lg:w-2/5">
...
function Submit() {
    ...
    return (
        <Button
            ...
            disabled={pending}
            type="submit"
            className="mt-8 flex w-3/4 items-center justify-center gap-4 rounded-md border px-10 py-2 lg:w-2/5"
        >
