...
export default function LoginForm({ setAuthModalVisible }: any) {
  ...
  return (
    <>
      ...
      >
        <div
          className={`flex flex-col w-full max-w-sm items-start gap-1.5 ${isTourActive ? "hidden" : "flex"}`}
        >
        ...
        {isTourActive ? null : (
          <>
            ...
            <Button
              onClick={loginTour}
              variant="ghostsecond"
              className="flex items-center mt-2 justify-center gap-4 w-full max-w-md login-tour"
            >
              <FlaskConical />
              Wypróbuj konto demo
            </Button>
